    ...
    <ChallengePage
      ...
      message={
        <>
          ...
          <p>More than anything else I can give you...</p>
          <p>that's the gift I treasure the most.</p>
          <p>I trust that wherever it leads you, it's where the true and living God wants you to be. ❤️</p>
        </>
      }
      challengeText={
        <>
