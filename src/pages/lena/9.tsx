...
export default function Nueve(): ReactNode {
  return (
    <ChallengePage
      ...
      challengeText={
        <>
          If I was there today... this is where I'd be sitting. ❤️<br /><br />
      ...
      hintText="Not a dog. Not a chair. Look beneath the four-legged thing where I learned “Alles oder nichts!”"
